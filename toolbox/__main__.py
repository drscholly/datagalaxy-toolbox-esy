...
from toolbox.commands.scan_dremio import scan_dremio, scan_dremio_parse
...
def run(args):
    ...
    # Scan
    if result.subparsers_name == 'scan-dremio':
        logging.info(">>> scan_dremio")
        scan_dremio(
            result.url,
            result.token,
            result.workspace,
